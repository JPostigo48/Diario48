...
export default function MusicTrackerEmptyPage() {
  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-[var(--bg)] text-[var(--tx)]">
      ...
      <section className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-[760px] rounded-[14px] border border-[var(--br)] bg-[var(--bg2)] p-8 text-center">
          ...
          <p className="mt-3 text-[14px] leading-[1.7] text-[var(--tx3)]">
            Esta herramienta te permitirá consolidar tu biblioteca musical, revisar metadata,
            detectar duplicados y exportar tu respaldo. Inicia sesión para operar tu espacio.
          </p>
        </div>
      </section>
    </main>
